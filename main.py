...
print(calculate(input("Enter chart title, boxplot title [-v for stripplot] and x-y axis titles (seperate by commas): "), sorted([float(i.strip()) for i in input("Enter some numbers: ").replace(",", ", ").split(" ")])))
